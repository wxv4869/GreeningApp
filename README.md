...
## 📝 목차
1. <a href="#진행-기간">진행 기간</a>
2. <a href="#팀-구성">팀 구성</a>
3. <a href="#서비스-개요">서비스 개요</a>
4. <a href="#프로젝트-기여-부분">프로젝트 기여 부분</a>
5. <a href="#개발-환경-및-기술-스택">개발 환경 및 기술 스택</a>
6. <a href="#사이트맵">사이트맵</a>
7. <a href="#주요-기능">주요 기능</a>
8. <a href="#db-firebase">DB (Firebase)</a>
9. <a href="#벤치마킹-및차별성">벤치마킹 및 차별성</a>
10. <a href="#판매-데이터-시각화-및-솔루션">판매 데이터 시각화 및 솔루션</a>
11. <a href="#수상-실적">수상 실적</a>
12. <a href="#시연-영상-youtube">시연 영상 (Youtube)</a>
<br><br>
